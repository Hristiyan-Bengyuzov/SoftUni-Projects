...
namespace Skeleton.Tests
{
    ...
    public class DummyTests
    {
        ...
        public void DummyLosesHealthIfAttacked()
        {
            ...
            axe.Attack(dummy);
            Assert.That(dummy.Health == EXPECTED_DUMMY_HEALTH, "Dummy loses health if attacked.");
        }
        ...
        public void DeadDummyThrowsAnExceptionIfAttacked()
        {
            ...
            Assert.IsTrue(exceptionIsThrown, "Dead dummy throws an exception if attacked.");
        }
        ...
        public void DeadDummyCanGiveXP()
        {
            ...
            Assert.That(getExperience, Is.EqualTo(INITIAL_DUMMY_EXPERIENCE), "Dead dummy gives experience.");
        }
        ...
        public void AliveDummyCannotGiveXP()
        {
            ...
            Assert.IsTrue(targetIsAliveExceptionIsThrown, "Alive dummy not able to give experience.");
        }
