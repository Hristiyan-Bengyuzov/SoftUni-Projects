...
namespace _11._Array_Manipulator
{
    internal class Program
    {
        ...
        static void FindNumbers(int[] arr, string possition, int numbersCount, string evenOdd)
        {
        ...
        static void FindMinMax(int[] arr, string minOrMax, string evenOrOdd)
        {
            int index = -1;
        ...
        static int[] ExchangeArr(int[] arr, int splitIndex)
        {
